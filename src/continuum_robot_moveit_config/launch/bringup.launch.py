...
def generate_launch_description():
    ...
    robot_urdf = "continuum_robot_gazebo.urdf.xacro"
    robot_urdf_directory = os.path.join(pkg_directory, "config")
    ...
    arg_robot_urdf = LaunchConfiguration('robot_urdf', default=robot_urdf)
    arg_robot_urdf_directory = LaunchConfiguration('robot_urdf_directory')
    ...
    ld.add_action(DeclareLaunchArgument('robot_urdf', default_value=robot_urdf))
    ld.add_action(DeclareLaunchArgument('robot_urdf_directory', default_value=[robot_urdf_directory, '/', arg_robot_urdf]))
    ...
    include_spawn_robot = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'y_pos': arg_y_pos,
            'z_pos': arg_z_pos,
            'robot_urdf': arg_robot_urdf_directory
        }.items()
    )
